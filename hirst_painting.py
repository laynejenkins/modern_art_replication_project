# used colorgram to extract the most used colors in spot_image. Also removed white-space rgb values.
...
# turn timmy invisible and only draw the dots.
timmy.penup()
timmy.hideturtle()
...
# timmy's starting position cannot be in the center, so timmy needs to be moved to the bottom-right corner.
